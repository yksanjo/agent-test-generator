/**
 * agent-test-generator-webhook - Integration: webhook for AI Test Case Generator
 * Project: agent-test-generator
 */
export class AgentTestGeneratorWebhook {
  constructor(options = {}) {
    this.name = 'agent-test-generator-webhook';
...
export default AgentTestGeneratorWebhook;
