/**
 * agent-test-generator-api - Package 2: api for AI Test Case Generator
 * Project: agent-test-generator
 */
export class AgentTestGeneratorApi {
  constructor(options = {}) {
    this.name = 'agent-test-generator-api';
...
export default AgentTestGeneratorApi;
