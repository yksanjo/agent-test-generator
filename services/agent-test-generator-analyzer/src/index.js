/**
 * agent-test-generator-analyzer - Service: analyzer for AI Test Case Generator
 * Project: agent-test-generator
 */
export class AgentTestGeneratorAnalyzer {
  constructor(options = {}) {
    this.name = 'agent-test-generator-analyzer';
...
export default AgentTestGeneratorAnalyzer;
